...
export namespace Locale {
  ...
  export function getLocaleObj(): Object {
    let localeObj: Object = {
      "de": {
        "schedule": {
          "day": "Tag",
          "week": "Woche",
  ...
  export function loadCultureFiles(localeName: string): void {
    const localeData = require('./cldr-data/main/' + localeName + '/all.json');
    loadCldr(localeData);
  }
}
